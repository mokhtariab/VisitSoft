...
namespace MehrParvarPrj
{
    public partial class NEUser_frm : Form
    {
        ...
        private bool InsertUser()
        {
            ...
            {
                Global_Cls.Message_MehrGostar(0, Global_Cls.MessageType.SError, false, "لطفا با کمی فاصله دوباره تایید نمایید!", ex.Message);
                return false;
            }
            return true;
        }
        ...
        private void buttonItem_OK_Click(object sender, EventArgs e)
        {
            ...
            {
                Global_Cls.Message_MehrGostar(0, Global_Cls.MessageType.SWarning, false, "نام کاربری را وارد نمایید");
                textBox_UserName.Focus();
                return;
            }
            if (textBox_ReNewPass.Text != textBox_NewPass.Text)
            {
                Global_Cls.Message_MehrGostar(0, Global_Cls.MessageType.SWarning, false, "رمزی که دوباره وارد شده اشتباه می باشد. دوباره آنرا وارد نمایید");
            ...
            if (InsOrEdt == 1)
            {
                if (!InsertUser())
                {
                    Global_Cls.Message_MehrGostar(0, Global_Cls.MessageType.SWarning, false, "نام کاربری تکراری است. دوباره آنرا وارد نمایید");
                    textBox_UserName.Focus();
                    return;
                }
            }
            if (InsOrEdt == 2)
            {
                ...
                if (EU == 0)
                {
                    Global_Cls.Message_MehrGostar(0, Global_Cls.MessageType.SWarning, false, "رمز قبلی اشتباه می باشد. دوباره آنرا وارد نمایید");

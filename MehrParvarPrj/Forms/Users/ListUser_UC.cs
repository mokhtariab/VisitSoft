    ...
    public partial class ListUser_UC : UserControl
    {
        ...
        private void bubbleButton_UDel_Click(object sender, DevComponents.DotNetBar.ClickEventArgs e)
        {
            try
            {
                ...
                {
                    Global_Cls.Message_MehrGostar(0, Global_Cls.MessageType.SWarning, false, "امکان حذف کاربر اصلی وجود ندارد");
                    return;
                }
                if (Global_Cls.Message_MehrGostar(0, Global_Cls.MessageType.SConfirmation, true, "آیا به حذف این کاربر اطمینان دارید؟"))
                {

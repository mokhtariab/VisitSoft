...
{
    public partial class DoctorVisitBilanCostReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public DoctorVisitBilanCostReport(string DateStart, string DateEnd, string HeaderText1, string HeaderText2, string HeaderText3, Image ImageSet, int DoctorId, bool MonthSet)
        {
            InitializeComponent();

            var gg = new List<DataLinq.CLS_SPDoctorVisitBilanCostReport>();

            var gg1 = (from l in DCDC.SP_DoctorVisitBilanCostReport(DateStart, DateEnd, DoctorId, MonthSet) 
                            select new { 
                                l.BankName, 
                                l.TelHome, 
                                l.CardBankNo1, 
                                ...
                                l.MonthSet,
                                l.RemindCost,
                                l.SumCostVisitDoctor,
                                l.SumCostVisitDoctorBes
            ...
            bindingSource1.DataMember = "CLS_SPDoctorVisitBilanCostReport";

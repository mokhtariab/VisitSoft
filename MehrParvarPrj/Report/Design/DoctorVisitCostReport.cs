...
{
    public partial class DoctorVisitCostReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public DoctorVisitCostReport(string DateStart, string DateEnd, string HeaderText1, string HeaderText2, string HeaderText3, Image ImageSet, bool LetterDate)
        {
            InitializeComponent();

            var gg = new List<DataLinq.CLS_SPDoctorVisitCostReport>();

            var gg1 = (from l in DCDC.SP_DoctorVisitCostReport(DateStart,DateEnd, LetterDate) 
                            select new { 
                                l.BankName, 
                                l.TelHome, 
                                l.CardBankNo1, 

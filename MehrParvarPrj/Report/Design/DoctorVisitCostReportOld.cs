...
{
    public partial class DoctorVisitCostReportOld : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public DoctorVisitCostReportOld(string DateStart, string DateEnd, string HeaderText1, string HeaderText2, string HeaderText3, Image ImageSet)
        {
            InitializeComponent();

            var gg = new List<DataLinq.CLS_SPDoctorVisitCostReport>();

            var gg1 = (from l in DCDC.SP_DoctorVisitCostReport(DateStart,DateEnd, false) 
                            select new { 
                                l.BankName, 
                                l.TelHome, 
                                l.CardBankNo1, 

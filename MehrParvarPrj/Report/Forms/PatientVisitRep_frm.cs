...
{
    public partial class PatientVisitRep_frm : Form
    {
        public PatientVisitRep_frm()
        {
            InitializeComponent();
        }
        ...
        private void PatientVisitRep_frm_Load(object sender, EventArgs e)
        {
            SetDateToModules();
            SetItemPanels();
        }
        ...
        {
            //if (itemPanel_StateSickness.Items.Count == 0)
            //    foreach (DataLinq.TBL_StateSickness jj in DCDC.TBL_StateSicknesses)
            //    {
            //        DevComponents.DotNetBar.CheckBoxItem Ch = new DevComponents.DotNetBar.CheckBoxItem();
            //        Ch.Name = jj.StateSicknessId.ToString();
            //        Ch.Text = jj.StateSicknessName.ToString();
            ...
            //        itemPanel_StateSickness.Items.Add(Ch);
            //        itemPanel_StateSickness.Refresh();
            //    }

            //if (itemPanel_Paraclinic.Items.Count == 0)
            //    foreach (DataLinq.TBL_Paraclinic jj in DCDC.TBL_Paraclinics)
            //    {
            //        DevComponents.DotNetBar.CheckBoxItem Ch = new DevComponents.DotNetBar.CheckBoxItem();
            //        Ch.Name = jj.ParaclinicId.ToString();
            //        Ch.Text = jj.ParaclinicName.ToString();
            //        Ch.CheckBoxStyle = DevComponents.DotNetBar.eCheckBoxStyle.CheckBox;
            //        //Ch.CheckBoxPosition = DevComponents.DotNetBar.eCheckBoxPosition.Bottom;
            //        itemPanel_Paraclinic.Items.Add(Ch);
            //        itemPanel_Paraclinic.Refresh();
            //    }
            //if (itemPanel_DrugsHistory.Items.Count == 0)
            //    foreach (DataLinq.TBL_Drug jj in DCDC.TBL_Drugs)
            //    {
            //        DevComponents.DotNetBar.CheckBoxItem Ch = new DevComponents.DotNetBar.CheckBoxItem();
            //        Ch.Name = jj.DrugsId.ToString();
            //        Ch.Text = jj.DrugsName.ToString();
            //        Ch.CheckBoxStyle = DevComponents.DotNetBar.eCheckBoxStyle.CheckBox;
            //        //Ch.CheckBoxPosition = DevComponents.DotNetBar.eCheckBoxPosition.Bottom;
            //        itemPanel_DrugsHistory.Items.Add(Ch);
            //        itemPanel_DrugsHistory.Refresh();
            //    }

            //if (itemPanel_Bedsore.Items.Count == 0)
            //    foreach (string jj in (from prd in DCDC.TBL_VisitStateBedsores
            //                                                   select prd.BedsorePosition).Distinct())
            //    {
            //        DevComponents.DotNetBar.CheckBoxItem Ch = new DevComponents.DotNetBar.CheckBoxItem();
            //        Ch.Name = jj;
            //        Ch.Text = jj;
            //        Ch.CheckBoxStyle = DevComponents.DotNetBar.eCheckBoxStyle.CheckBox;
            //        //Ch.CheckBoxPosition = DevComponents.DotNetBar.eCheckBoxPosition.Bottom;
            //        itemPanel_Bedsore.Items.Add(Ch);
            //        itemPanel_Bedsore.Refresh();
            //    }
        ...
        private void SetDateToModules()
        {
            ...
            comboBox_PatientVisitYear1.Text = farsi.GetYear(DateTime.Now.AddDays(-30)).ToString(); comboBox_PatientVisitYear2.Text = farsi.GetYear(DateTime.Now).ToString();
            comboBox_PatientVisitMonth1.Text = farsi.GetMonth(DateTime.Now.AddDays(-30)).ToString(); comboBox_PatientVisitMonth2.Text = farsi.GetMonth(DateTime.Now).ToString();
            comboBox_PatientVisitday1.Text = farsi.GetDayOfMonth(DateTime.Now.AddDays(-30)).ToString(); comboBox_PatientVisitDay2.Text = farsi.GetDayOfMonth(DateTime.Now).ToString();
        }
        ...
        private void buttonItem_list_Click(object sender, EventArgs e)
        {
            ...
            ListPatientVisitReport_frm CC = new ListPatientVisitReport_frm(true, true, 0, 0);
